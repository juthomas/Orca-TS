...
library.a = function OperatorA (orca: IOrca, x: number, y: number, passive?: boolean) {
...
library.b = function OperatorB (orca: IOrca, x: number, y: number, passive?: boolean) {
...
library.c = function OperatorC (orca: IOrca, x: number, y: number, passive?: boolean) {
...
library.d = function OperatorD (orca: IOrca, x: number, y: number, passive?: boolean) {
...
library.e = function OperatorE (orca: IOrca, x: number, y: number, passive?: boolean) {
...
library.f = function OperatorF (orca: IOrca, x: number, y: number, passive?: boolean) {
...
library.g = function OperatorG (orca: IOrca, x: number, y: number, passive?: boolean) {
...
library.h = function OperatorH (orca: IOrca, x: number, y: number, passive?: boolean) {
...
library.i = function OperatorI (orca: IOrca, x: number, y: number, passive?: boolean) {
...
library.j = function OperatorJ (orca: IOrca, x: number, y: number, passive?: boolean) {
...
library.k = function OperatorK (orca: IOrca, x: number, y: number, passive?: boolean) {
...
library.l = function OperatorL (orca: IOrca, x: number, y: number, passive?: boolean) {
...
library.m = function OperatorM (orca: IOrca, x: number, y: number, passive?: boolean) {
...
library.n = function OperatorN (orca: IOrca, x: number, y: number, passive?: boolean) {
...
library.o = function OperatorO (orca: IOrca, x: number, y: number, passive?: boolean) {
...
library.p = function OperatorP (orca: IOrca, x: number, y: number, passive?: boolean) {
...
library.q = function OperatorQ (orca: IOrca, x: number, y: number, passive?: boolean) {
...
library.r = function OperatorR (orca: IOrca, x: number, y: number, passive?: boolean) {
...
library.s = function OperatorS (orca: IOrca, x: number, y: number, passive?: boolean) {
...
library.t = function OperatorT (orca: IOrca, x: number, y: number, passive?: boolean) {
...
library.u = function OperatorU (orca: IOrca, x: number, y: number, passive?: boolean) {
...
library.v = function OperatorV (orca: IOrca, x: number, y: number, passive?: boolean) {
...
library.w = function OperatorW (orca: IOrca, x: number, y: number, passive?: boolean) {
...
library.x = function OperatorX (orca: IOrca, x: number, y: number, passive?: boolean) {
...
library.y = function OperatorY (orca: IOrca, x: number, y: number, passive?: boolean) {
...
library.z = function OperatorZ (orca: IOrca, x: number, y: number, passive?: boolean) {
...
library['*'] = function OperatorBang (orca: IOrca, x: number, y: number, passive?: boolean) {
...
library['#'] = function OperatorComment (orca: IOrca, x: number, y: number, passive?: boolean) {
  Operator.call(this, orca, x, y, '#', true)
...
library.$ = function OperatorSelf (orca: IOrca, x: number, y: number, passive?: boolean) {
  Operator.call(this, orca, x, y, '*', true)
...
library[':'] = function OperatorMidi (orca: IOrca, x: number, y: number, passive?: boolean) {
  Operator.call(this, orca, x, y, ':', true)
...
library['!'] = function OperatorCC (orca: IOrca, x: number, y: number) {
  Operator.call(this, orca, x, y, '!', true)
...
library['?'] = function OperatorPB (orca: IOrca, x: number, y: number) {
  Operator.call(this, orca, x, y, '?', true)
...
library['%'] = function OperatorMono (orca: IOrca, x: number, y: number, passive?: boolean) {
  Operator.call(this, orca, x, y, '%', true)
...
library['='] = function OperatorOsc (orca: IOrca, x: number, y: number, passive?: boolean) {
  Operator.call(this, orca, x, y, '=', true)
...
library[';'] = function OperatorUdp (orca: IOrca, x: number, y: number, passive?: boolean) {
  Operator.call(this, orca, x, y, ';', true)
...
for (let i = 0; i <= 9; i++) {
  library[`${i}`] = function OperatorNull (orca: IOrca, x: number, y: number, passive?: boolean) {
